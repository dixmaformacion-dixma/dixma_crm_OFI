      ...
      <div style="margin-top: 5.85cm; margin-left:0.85cm; margin-right:0.85cm">
        ...
        <div class="inputrow" style="margin-top: 0.75cm">
          <div class="single-input">
            ...
            <div class="dato" style="width:14.2cm; text-transform:uppercase" contenteditable="true"><?php echo $alumnocurso['Denominacion'] ?></div>
            <!--<input class="form-control" style="width:14.2cm; text-transform:uppercase" value="<?php echo $alumnocurso['Denominacion'] ?>" type="text"></input>-->
          </div>
        </div>
  ...
  <div class="row mb-2 mt-2" id="volver">
    <script>
      ...
      function resetContenidosFontSize(){
        contenidosElement.style.fontSize = "3.6mm";
      }
    </script>
    <div class="col-12 text-center">
...
<div class="privado" style="display:none">
  <div class="pagewrapper" style="padding:0mm;">
    <div class="page privado-back" style="background:url(images/diploma/privado1.png); background-repeat: no-repeat; background-size: cover;">
      ...
      <div class="entidadText" style="text-align:center;font-size: 4mm;position: absolute;left: 5.5cm;width: 220px;bottom: 0.6cm;z-index:10" contentEditable="true">
