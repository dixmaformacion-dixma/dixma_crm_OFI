                ...
                <?php
                    ...
                    if(!empty($empresas)){
                        ...
                        echo "<div class='row mx-auto'>";
                            echo "<button type='button' class='btn col-md-5 col-12 mx-auto mb-2' style='background-color: #1e989e;' onclick='nuevaFichaAlumno(" . $empresas[$i]['idempresa'] . ")'>NUEVA FICHA <img src='images/iconos/person-add.svg' class='ml-5'> </button>";
                        echo "</div>"; 
