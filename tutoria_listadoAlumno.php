<?php
    ...
    if(isset($_GET['consultar']) && $_SERVER['REQUEST_METHOD'] == 'GET' && $_GET['consultar'] == "Eliminar" && isset($_GET['idAlumno'])){
        if(eliminarAlumno($_GET['idAlumno'])){
            echo "<div class='sucess'>Alumno eliminada exitosamente</div>";
        }else{
            echo "<div class='alert alert-danger' role='alert'>No se pudo eliminar esta alumno</div>";
        }
    }
            ...
            <div class="col-md-10 col-12" id="formBusqueda">
                ...
                <?php
                    ...
                    if(!empty($alumnos)){
                        ...
                        $onclick = 'onclick=\'
                            if (confirm("Esta acción es irreversible, ¿Estás seguro de que deseas eliminar a este estudiante?")) {
                                window.location.href = "tutoria_listadoAlumno.php?idAlumno='.$alumno['idAlumno'].'&consultar=Eliminar";
                            }
                        \'';
                            
                        ?>
                            <div>
                                <div class='container-fluid border rounded mt-3 mb-3 border-5'>
                                    <div class='row mx-auto my-2'>
                                        ...
                                        <label class='col-4'>
                                                <?php echo "<button type='button' class='btn btn-danger' ".$onclick."><img src='images/iconos/x-circle-fill.svg' class='ml-5' style='filter: invert(1);'> </button></td>"; ?>
                                                <a href='tutoria_editarAlumno.php?idAlumno=<?php echo $alumno['idAlumno']; ?>' type='button' class='btn btn-primary'><img src='images/iconos2/pencil-square.svg' class='ml-5' style='filter: invert(1);'></a>
                                        </label>
                                    </div>
                                </div>
                            </div>
