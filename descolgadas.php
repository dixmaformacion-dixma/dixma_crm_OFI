                    ...
                    <?php 
                        sqlToHtml($empresas,[
                            ...
                            'acciones'=>function($val,$row){
                                return '<a href="/consultarEmpresa.php?idEmpresa='.$row['idempresa'].'&tipo=undefined&fechaInicio=&fechaFin=&poblacion=&provincia=&redirect='.urlencode('descolgadas.php').'" class="btn btn-info">Consultar</a>';
                            }
                        ]) 
                    ?>
                    </div>
