<?php
    ...
    if(isset($_GET['consultar']) && $_SERVER['REQUEST_METHOD'] == 'GET'){
            ...
            if($empresasListado = buscarPorProvincia($datosProvincia)){
        ...
        <div class="row">
            ...
            <div class="col-md-10 col-12" id="formListado">
                ...
                <form method="GET">
                    ...
                    <h2 class="text-center mt-2 pt-2 pb-3 mb-md-5 mb-3 border border-5 rounded" style="background-color: #b0d588; letter-spacing: 7px;">LISTADO</h2>
            ...
            <?php
                ...
                if(!empty($empresasListado)){
                    ...
                    echo " <h2 class='text-center mt-2 pt-2 pb-3 mb-md-3 mb-3 border border-5 rounded' style='background-color: #b0d588; letter-spacing: 7px;'>LISTADO</h2>";
                    ...
                    for($i=0; $i < count($empresasListado); $i++){

                        echo "<tr>";

                        echo "<td>" . $empresasListado[$i]['idempresa'] . "</td>";
                        echo "<td>" . $empresasListado[$i]['nombre'] . "</td>";
                        echo "<td>" . $empresasListado[$i]['cliente'] . "</td>";
                        echo "<td>" . $empresasListado[$i]['cp'] . "</td>";
                        echo "<td>" . $empresasListado[$i]['provincia'] . "</td>";
                        echo "<td>" . $empresasListado[$i]['poblacion'] . "</td>";
                        echo "<td> <button type='button' class='btn' style='background-color: #1e989e;' onclick='enviarConsulta(" . $empresasListado[$i]['idempresa'] . ")'>Consultar <img src='images/iconos/info-circle.svg' class='ml-5'> </button> </td>";
