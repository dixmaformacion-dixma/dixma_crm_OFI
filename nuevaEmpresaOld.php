<?php
    ...
    if(isset($_POST['insertar']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(insertarNuevaEmpresa($datosEmpresa)){
            ...
            //$prueba = '<div class="alert alert-danger text-center">ERROR: Empresa repetida</div>';

            //echo "<script src='js/jquery-3.6.1.min.js'></script>";

            //echo "<script> $(document).ready(function() { ";
            //echo  "$('#formNuevaEmpresa').empty();";
            //echo "$('#formNuevaEmpresa').append('$prueba');";
            //echo "}); </script>";

            //header("Location: empresaRepetida.php");
   ...
   header('Refresh: 1; URL=consultarEmpresa.php?idEmpresa=' . $idEmpresa); 
                ...
                <form class="col-12" method="POST" id="formNuevaEmpresa">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-12">
                            ...
                            <input class="form-control" value="" name="nombreEmpresa" required></input>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <input class="form-control" name="telefono" required></input>
                        </div>
