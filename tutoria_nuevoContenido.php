<?php
    ...
    if(isset($_POST['insertar']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        nuevoContenido($datosContenido);

        header('location:tutoria_cursosContenido.php');
...
<div class="row">
    ...
    <div class="col-md-10 col-12" id="datosEmpresa">
        ...
        <h2 class="text-center mt-2 pt-2 pb-3 mb-md-2 mb-3 border border-5" style="background-color: #b0d588; letter-spacing: 7px;">NUEVO CONTENIDO</h2>
                ...
                <input name="admin" id="callcenter" value="<?php echo ($codigoCallCenter[0] + 1) ?>" hidden="true"></input>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <input class="form-control" name="N_Accion" required></input>
                        </div>

                        <div class="col-md-6 col-12">
                            <label><b>Año:</b></label>
                            <input class="form-control" name="Anno" required></input>
                        </div>
