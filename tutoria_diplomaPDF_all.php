...
$sql = '
  ...
  WHERE `StudentCursoID` IN (' . $_GET['ids'] . ')
  ';

$conexionPDO->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_WARNING);
$stmt = $conexionPDO->prepare($sql);

//$stmt->bindValue(1, $_GET['ids'], PDO::PARAM_STR);
  ...
  <script>
    function MostrarDiploma(tipo, aditional = false) {
      ...
      for (diploma of diplomas) {
        ...
        console.log(document.getElementsByClassName(diploma));
        for (var i of document.getElementsByClassName(diploma)) {
          i.style.display = 'none';
        }
      }
      //document.getElementById(tipo).style.display = 'block';
      for (var i of document.getElementsByClassName(tipo)) {
      ...
      if (tipo == "soldadura") {
        ...
        if (tipo == "privado") {
          for (var i of document.getElementsByClassName("privado-back")) {
            i.style.backgroundImage = 'url(images/diploma/privado' + aditional + '.png)';
          }

          if (aditional == "1") {
            $('.firma_docente').hide();
            for (var i of document.getElementsByClassName("fecha_privado")) {
              i.style.left = "138mm";
            }
  ...
  <div class="row mb-2 mt-2" id="volver">
    ...
    <div class="py-2 d-flex" style="justify-content:center">
      <button class="col-2 btn text-center"
        onclick="MostrarDiploma('bonificado');">Bonificado</button>
      <button class="col-2 btn text-center"
        onclick="MostrarDiploma('privado', '1')">Privado</button>
      <button class="col-2 btn text-center"
        onclick="MostrarDiploma('privado', '3')">Privado firma docente</button>
      <button class="col-2 btn text-center"
        onclick="MostrarDiploma('estetica')">Estética</button>
      <button class="col-2 btn text-center"
        onclick="MostrarDiploma('soldadura')">Soldadura</button>
    </div>
  </div>
  <?php
  ...
  ?>
          ...
          <div style="margin-top: 5.85cm; margin-left:0.85cm; margin-right:0.85cm">
            ...
            <div class="inputrow">
              <div class="single-input">
                ...
                <input class="form-control" style="width:2cm; text-align:center" value="<?php if ($alumnocurso['Modalidad'] == "Teleformación") {
                                                                                          echo $alumnocurso['N_Horas'];
                                                                                        } else {
                                                                                          echo "0";
                                                                                        } ?>" type="text"></input>
              </div>
            ...
            <div class="inputrow">
              <div class="single-input">
                ...
                <input class="form-control" style="width:2cm; text-align:center" value="<?php if ($alumnocurso['Modalidad'] == "Presencial") {
                                                                                          echo $alumnocurso['N_Horas'];
                                                                                        } else {
                                                                                          echo "0";
                                                                                        } ?>" type="text"></input>
    ...
    <div class="privado" style="display:none">
      <div class="pagewrapper" style="padding:0mm;">
        <div class="page privado-back" style="background:url(images/diploma/privado1.png); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="d-flex justify-content-center">
            <div style="text-align:center; font-size:6mm; margin-top:-1.26cm">con DNI: <span id="DNI" contenteditable="true"><?php echo strtoupper($alumnocurso['nif']); ?></span> ha realizado satisfactoriamente la formación de:</div>
          </div>
          <div class="d-flex justify-content-center">
          ...
          <div class="fecha_privado" style="position:absolute; bottom:22mm;">
            <div id="fecha" style="text-align:center; font-size:6mm; position:relative; left:0.5cm" contenteditable="true">
              <?php echo formattedDate($fecha_emision) ?>
            </div>
          </div>
        </div>
      </div>
      <div class="row mb-2 mt-2 d-none" id="volver">
        <label>Nomre:</label>
    ...
    <div class="estetica" style="display:none">
      <div class="pagewrapper" style="padding:0mm;">
        <div class="page" style="background:url(images/diploma/estetica1.png); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="d-flex justify-content-center estetica_info">
            <div style="text-align:center; font-size:5.5mm; margin-top:-0.10cm">con DNI: <span id="est_DNI" contenteditable="true"><?php echo strtoupper($alumnocurso['nif']); ?></span> ha realizado satisfactoriamente la formación de:</div>
          </div>
          <div class="d-flex justify-content-center estetica_info">
          ...
          <div class="d-flex justify-content-center estetica_info">
            <div id="est_details" style="text-align:center; font-size:5.5mm; margin-top:0.75cm;" contenteditable="true">
          ...
          <div class="estetica_info" style="position:absolute; bottom:17mm; left: 121mm">
            <div id="est_fecha" style="text-align:center; font-size:4mm; position:relative; left:0.5cm" contenteditable="true">
              <?php echo formattedDate(Date("Y-m-d")); ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="soldadura" style="display:none">
      <div class="pagewrapper2" style="padding:0mm;">
        <div class="page" style="background:url(images/diploma/soldadura1.png); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="d-flex justify-content-center soldadura_info">
            <div style="text-align:center; font-size:5.5mm; margin-top:0.7cm; margin-left:1.50cm; margin-right:1.50cm;">CON DNI: <span id="sold_DNI" contenteditable="true"><?php echo strtoupper($alumnocurso['nif']); ?></span> HA REALIZADO SATISFACTORIAMENTE LA FORMACIÓN DE:</div>
          </div>
          <div class="d-flex justify-content-center soldadura_info">
          ...
          <div class="d-flex justify-content-center soldadura_info">
            <div id="sold_details" style="text-align:center; font-size:5.5mm; margin-top:0.50cm;  margin-left:1.50cm; margin-right:1.50cm;" contenteditable="true">
              entre el <?php echo formattedDate(strtoupper($alumnocurso['Fecha_Inicio'])); ?> y el <?php echo formattedDate(strtoupper($alumnocurso['Fecha_Fin'])); ?> con una duración de <?php echo strtoupper($alumnocurso['N_Horas']); ?> horas en modalidad <?php echo $alumnocurso['Modalidad']; ?>
            </div>
          </div>
          ...
          <div class="soldadura_info" style="position:absolute; bottom:37mm; left: 160mm">
            <div id="sold_fecha" style="text-align:center; font-size:4mm; position:relative; left:0.5cm" contenteditable="true">
              <?php echo formattedDate(Date("Y-m-d")); ?>
            </div>
          </div>
        </div>
