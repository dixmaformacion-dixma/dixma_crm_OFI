                        ...
                        <form method="get">
                            <div class="mx-auto row col-md-7 col-12 mb-5">
                                ...
                                <div class="row">
                                    <label class='col-12'>
                                        <b>Tipo venta:</b>
                                        <input class="form-check-input" type="radio" name="Tipo_Venta_Display" Value="Todos" <?php if ($Tipo_Venta_Display == "Todos") {
                                                                                                                                    echo "checked";
                                                                                                                                } ?>>
                                        <label class="form-check-label" for="Todos">
                                            Todos
                                        </label>
                                        <input class="form-check-input" type="radio" name="Tipo_Venta_Display" Value="Bonificado" <?php if ($Tipo_Venta_Display == "Bonificado") {
                                                                                                                                        echo "checked";
                                                                                                                                    } ?>>
                                        <label class="form-check-label" for="Bonificado">
                                            Bonificado
                                        </label>
                                        <input class="form-check-input" type="radio" name="Tipo_Venta_Display" Value="Privado" <?php if ($Tipo_Venta_Display == "Privado") {
                                                                                                                                    echo "checked";
                                                                                                                                } ?>>
