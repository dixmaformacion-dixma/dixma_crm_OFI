    ...
    <div>
                <div class="row">
                        <label class='col-auto'>
                                ...
                                <input type="checkbox" class="form-check-input" disabled <?php if($curso['seguimento0check'] == 1){ echo "checked"; } ?>>
                        </label>
            ...
            <div class="row">
                    <label class='col-auto'>
                            ...
                            <input type="checkbox" class="form-check-input" disabled <?php if($curso['seguimento1check'] == 1){ echo "checked"; } ?>>
                    </label>
            ...
            <div class="row">
                    <label class='col-auto'>
                            ...
                            <input type="checkbox" class="form-check-input" disabled <?php if($curso['seguimento2check'] == 1){ echo "checked"; } ?>>
                    </label>
            ...
            <div class="row">
                    <label class='col-auto'>
                            ...
                            <input type="checkbox" class="form-check-input" disabled <?php if($curso['seguimento3check'] == 1){ echo "checked"; } ?>>
                    </label>
            ...
            <div class="row">
                    <label class='col-auto'>
                            ...
                            <input type="checkbox" class="form-check-input" disabled <?php if($curso['seguimento4check'] == 1){ echo "checked"; } ?>>
                    </label>
            </div>
            <div class="row">
                    <label class='col-auto'>
                            ...
                            <input type="checkbox" class="form-check-input" disabled <?php if($curso['seguimento5check'] == 1){ echo "checked"; } ?>>
                    </label>
            </div>
