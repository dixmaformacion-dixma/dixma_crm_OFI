<?php 
    ...
    'credito_pendiente.php'=>'<img class="ms-3" src="images/iconos/calendar.svg"> <b> Creditos por Caducar </b>',
    ...
    if($_SESSION['codigoUsuario']==200){
        foreach([
            'sectores.php',
            'credito_pendiente.php',
            'descolgadas.php'
        ] as $unset)
        unset($itemsMenu[$unset]);
    }
?>
<div class="col-md-2 col-12 align-items-start text-justify" style="background-color:#e4e4e4;">
    <nav class="navbar-nav nav-pills flex-column mt-2 mb-2">
        <?php 
        foreach($itemsMenu as $file=>$meta): ?>
