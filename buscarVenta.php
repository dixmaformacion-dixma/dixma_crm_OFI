            ...
            <div class="col-md-10 col-12" id="formBusqueda">
                ...
                <?php
                    ...
                    if(!empty($empresas)){
                        ...
                        echo "<h2 class='text-center mt-2 pt-2 pb-2 border border-5' style='background-color: #b0d588;'>CONSULTAR EMPRESAS</h2>";
                        ...
                        echo "<div class='row mx-auto'>";
                            echo "<button type='button' class='btn col-md-12 col-12 mx-auto mb-2' style='background-color: #8fd247;' onclick='consultaAdministracion(" . $empresas[$i]['idempresa'] . ")'>Consultar <img src='images/iconos/info-circle.svg' class='ml-5'> </button>";
                        echo "</div>";
