<?php
    ...
    if(isset($_POST['insertar']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(isset($_POST['estadoLlamada'])){
            ...
            if(isset($_POST['seguimiento'])){
                ...
                $estadoLlamada = "Hacer seguimiento " . $nombre[0];
    ...
    if($listadoCursos = cursosInteresados($_GET['idEmpresa'])){
                                    ...
                                    <?php
                                        ...
                                        if(!empty($listadoCursos)){
                                            ...
                                            for($i=0; $i < count($listadoCursos); $i++){
                                                ...
                                                echo "<label class='col-12 col-md-3'> <b>Estado:</b> " . $listadoCursos[$i]['estadoCurso'] . "</label>";
                                                echo "<label class='col-12 col-md-9'> <b>Curso interesado:</b> " . $listadoCursos[$i]['Curso'] . "</label>";
                                                echo "</div>";
