<?php
    ...
    if(isset($_POST['insertar']) && $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(isset($_POST['estadoLlamada'])){
            ...
            if($_POST['estadoLlamada'] == "pendiente"){
                        ...
                        <form class="col-12" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <label>Si:</label>
                                    <input type="radio" id="guardaCredito" name="guardaCredito">

                                    <label>No:</label>
                                    <input type="radio" id="guardaCreditoNo" name="guardaCredito" value="No">

                                    <input class="form-control" id="cajaGuardaCredito" value="<?php echo $empresa['creditoGuardado'] ?>" name="creditoGuardado" type="text" disabled></input>
                                </div>
