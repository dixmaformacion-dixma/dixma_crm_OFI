<?php
    ...
    if(isset($_GET['consultar']) && $_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        if(empty($_GET['valor'])){
            ...
            if($empresas = buscarEmpresasPorID($_GET['valor'])){
            ...
            <div class="col-md-10 col-12" id="formBusqueda">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row d-flex justify-content-center mb-5">
                            ...
                            <div class="form-group col-md-4 col-12 text-center">
                                ...
                                <label class="form-label">Inserta <b>ID</b> de la empresa:</label>
                ...
                <?php
                    ...
                    if(!empty($empresas)){
                        ...
                        echo "<h2 class='text-center mt-2 pt-2 pb-2 border border-5' style='background-color: #b0d588; letter-spacing: 7px;'>ELIMINAR EMPRESAS</h2>";
                        ...
                        echo "<div class='border row mt-2 mb-3 mx-2' style='background-color: #e8f0f7;'>";
                            echo "<h5 class='col-md-4 col-4 my-md-auto'> ID:" . $empresas['idempresa'] . "</h5>";
                            echo "<h5 class='col-md-8 col-8 my-md-2'>" . $empresas['nombre'] . "</h5>";
                        echo "</div>";
                        
                        echo "<div class='row mx-auto my-2'>";
                            echo "<label class='col-md-4 col-12'> <b>CIF:</b> " . $empresas['cif'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Crédito:</b> " . $empresas['credito'] . "€</label>";
                            echo "<label class='col-md-4 col-12'> <b>Nº Empleados:</b> " . $empresas['numeroempleados'] . "</label>";
                        echo "</div>";

                        echo "<div class='row mx-auto my-2'>";
                            echo "<label class='col-md-4 col-12'> <b>Calle:</b> " . $empresas['calle'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Codigo postal:</b> " . $empresas['cp'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Provincia:</b> " . $empresas['provincia'] . "<b> Poblacion:</b> " . $empresas['poblacion'] .  "</label>";
                            //echo "<label class='col-md-4 col-12'> <b>Poblacion:</b> " . $empresas[$i]['poblacion'] . "</label>";
                        echo "</div>";

                        echo "<div class='row mx-auto my-2'>";
                            echo "<label class='col-md-4 col-12'> <b>Telefono:</b> " . $empresas['telef1'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Telefono 2:</b> " . $empresas['telef2'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Telefono 3:</b> " . $empresas['telef3'] . "</label>";
                        echo "</div>";

                        echo "<div class='row mx-auto my-2'>";
                            echo "<label class='col-md-4 col-12'> <b>Email:</b> " . $empresas['email'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Persona contacto:</b> " . $empresas['personacontacto'] . "</label>";
                            echo "<label class='col-md-4 col-12'> <b>Cargo persona contacto:</b> " . $empresas['cargo'] . "</label>";
                        echo "</div>";

                        echo "<div class='row mx-auto my-2'>";
                            echo "<label class='col-md-12 col-12 mb-3'> <b>Observaciones:</b> " . $empresas['observacionesempresa'] . "</label>";
                        echo "</div>";

                        echo "<div class='row mx-auto'>";
                            echo "<button type='button' class='btn btn-danger col-md-8 col-12 mx-auto mb-2' onclick='eliminarEmpresa(" . $empresas['idempresa'] . ")'>ELIMINAR <img src='images/iconos/exclamation-triangle.svg' class='ml-5'> </button>";
                        echo "</div>";
